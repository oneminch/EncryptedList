  ...
  return (
    <div className="w-72 mx-auto my-4 flex items-center justify-center gap-x-4">
      <button
        ...
        className="flex items-center justify-center w-10 h-10 py-1 font-semibold duration-150 bg-yellow-500 border border-zinc-800 dark:border-yellow-500 rounded-full focus-visible:global-focus ring-offset-zinc-50 dark:ring-offset-zinc-950 text-zinc-800 group/hover-effect disabled:bg-zinc-300 dark:disabled:bg-zinc-700 disabled:border-zinc-400 dark:disabled:border-zinc-700 disabled:text-zinc-400 cursor-pointer disabled:cursor-not-allowed">
        <Icon
