  ...
  return (
    <Drawer.Root>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="text-left px-6 pt-2 pb-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-300 overflow-hidden flex flex-col rounded-t-lg mt-24 h-fit fixed bottom-0 left-0 right-0 outline-none">
