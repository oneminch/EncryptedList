...
const SearchSuggestions: React.FC<SearchSuggestionsProps> = ({
  ...
  return (
    <ul
      ...
      className={`w-full mt-2 max-h-72 bg-white dark:bg-zinc-900 z-50 border-[0.9px] border-zinc-300 dark:border-zinc-700 rounded-md shadow-xl shadow-black/15 dark:shadow-black overflow-y-auto overflow-x-hidden ${className}`}>
      {isError && (
